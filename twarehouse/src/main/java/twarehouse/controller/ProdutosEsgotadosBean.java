...
@Named
@RequestScoped
public class ProdutosEsgotadosBean extends ListaSimple<ProdutoEmReposicao> implements Serializable {
	...
	public void listarComPaginacao() {
		produtos = estoqueService
				.listaProdutosEsgotados(getPaginator().getFirstResult(), getPaginator().getQtdPorPagina());
	}
